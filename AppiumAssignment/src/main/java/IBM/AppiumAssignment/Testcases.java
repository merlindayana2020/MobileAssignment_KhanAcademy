...
public class Testcases extends AndriodCap {
	...
	public void login() throws Exception {
		...
		driver.findElement(By.xpath("//*[@text='Enter an e-mail address or username']"))
				.sendKeys("merlin.dayana@yahoo.co.in");

		// enter password
		driver.findElement(By.xpath("//*[@text='Password']")).sendKeys("elearning123");
	...
	public void joinClass() throws InterruptedException {
		...
		driver.findElementByAccessibilityId("e.g. ABC123 or teacher@example.com").sendKeys("maha@gmail.com");
		...
		driver.findElementByAccessibilityId("e.g. ABC123 or teacher@example.com").sendKeys("dayana");
